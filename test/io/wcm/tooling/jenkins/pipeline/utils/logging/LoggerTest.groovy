...
class LoggerTest extends DSLTestBase {
  ...
  void shouldLogObject() throws Exception {
    ...
    assertLogSize(6)
    assertEquals("[TRACE] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerTest : my message -> (io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerTest) " + this.toString(), getLogMessageAt(0))
    assertEquals("[DEBUG] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerTest : my message -> (io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerTest) " + this.toString(), getLogMessageAt(1))
    assertEquals("[INFO] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerTest : my message -> (io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerTest) " + this.toString(), getLogMessageAt(2))
    assertEquals("[WARN] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerTest : my message -> (io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerTest) " + this.toString(), getLogMessageAt(3))
    assertEquals("[ERROR] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerTest : my message -> (io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerTest) " + this.toString(), getLogMessageAt(4))
    assertEquals("[FATAL] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerTest : my message -> (io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerTest) " + this.toString(), getLogMessageAt(5))
  }
