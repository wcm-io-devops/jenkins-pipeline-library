...
class LoggerCpsScriptTest extends CpsScriptTestBase {
  ...
  void shouldLogObject() throws Exception {
    ...
    assertLogSize(6)
    assertEquals("[TRACE] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest : my trace message -> (io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest) " + this.toString(), getLogMessageAt(0))
    assertEquals("[DEBUG] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest : my debug message -> (io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest) " + this.toString(), getLogMessageAt(1))
    assertEquals("[INFO] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest : my info message -> (io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest) " + this.toString(), getLogMessageAt(2))
    assertEquals("[WARN] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest : my warn message -> (io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest) " + this.toString(), getLogMessageAt(3))
    assertEquals("[ERROR] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest : my error message -> (io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest) " + this.toString(), getLogMessageAt(4))
    assertEquals("[FATAL] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest : my fatal message -> (io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest) " + this.toString(), getLogMessageAt(5))
  }
  ...
  void shouldSwitchColorOutputInstantly() {
    ...
    List<String> expectedLogMessages = [
        "[INFO] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest : without color 1",
        "\u001B[1;38;5;0m[INFO]\u001B[0m io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest : with color",
        "[INFO] io.wcm.tooling.jenkins.pipeline.utils.logging.LoggerCpsScriptTest : without color 2"
    ]
