...
import static io.wcm.testing.jenkins.pipeline.StepConstants.OPENTASKS

class TaskScannerPluginMock {

  TaskScannerPluginMock(LibraryIntegrationTestContext context) {
